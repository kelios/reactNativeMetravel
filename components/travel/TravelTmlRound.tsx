...
import { View, Pressable, StyleSheet, useWindowDimensions, Image, Platform } from 'react-native';
import { Paragraph, Text } from 'react-native-paper';
import { Travel } from '@/src/types/types';
import { router } from 'expo-router';

type TravelTmlRoundProps = { travel: Travel };

const TravelTmlRound = ({ travel }: TravelTmlRoundProps) => {
  const { name, slug, travel_image_thumb_small_url, countryName } = travel;
      ...
      <View style={styles.container}>
        ...
        >
          <View style={[styles.shadow, { alignItems: 'center', padding: 10 }]}>
            ...
            <Paragraph numberOfLines={1} ellipsizeMode="tail" style={styles.paragraph}>
...
const styles = StyleSheet.create({
  ...
  paragraph: { fontSize: 14, textAlign: 'center', color: '#555', maxWidth: 200 },
  imageWrapper: { overflow: 'hidden', backgroundColor: '#eee' },
